...
function ReportSales() {
  ...
  const getTransaction = async () => {
    ...
    Axios.post(
      `${API_URL}/apis/product/sales?bulan=${bulan}&tahun=${tahun}&search=${search}&warehouse=${selectedWarehouse}&category=${selectedCategory}&limit=${limit}&page=${
        parseInt(page) - 1
      }`,
      {
        bulan: bulan,
  ...
  // ACCESS
  useEffect(() => {
    document.title = "Cnc || Sales Report";

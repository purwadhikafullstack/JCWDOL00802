...
const OrderPage = (props) => {
  ...
  const getOrder = async () => {
    await Axios.post(
      `${API_URL}/apis/trans/list?limit=${limit}&page=${page - 1}`,
      {
        month: month,
        year: year,
        search: search,
  ...
  let changeStatus = async (id, stat) => {
    ...
    if (window.confirm(text)) {
      const change = await Axios.get(
        `${API_URL}/apis/trans/changestatus?id=${id}&stat=${stat}`,
        {
          headers: {
            Authorization: `Bearer ${userToken}`,
          },
                        ...
                        {val.transaction_status == 1 && (
                          <>
                            <Button
                              ...
                              mx="1"
                              onClick={() =>
                                changeStatus(val.id_transaction, 9)
                              }
                            >
                              cancel
                            </Button>
                        ...
                        {val.transaction_status == 6 && (
                          <>
                            <Button
                              ...
                              colorScheme="orange"
                              onClick={() =>
                                changeStatus(val.id_transaction, 7)
                              }
                            >
                              terima pesanan
                            </Button>
                            <Button
                              ...
                              colorScheme="orange"
                              onClick={() =>
                                changeStatus(val.id_transaction, 8)
                              }
                            >
                              ajukan komplain
                            </Button>
    ...
    <div className="container-fluid pt-3 px-3 ">
      <div className="row">
        ...
        <div className="col-2 row">
          <SidebarOrder onWaitClick={handleWaiting} />
        </div>

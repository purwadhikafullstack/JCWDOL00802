  ...
  const addToCart = async (id) => {
    try {
      let add = await Axios.post(
        `${API_URL}/apis/wishlist/cart?id=${id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${userToken}`,
      ...
      {wishlistData && (
        <Box py={4} display="flex" flexWrap="wrap">
          ...
          {wishlistData?.map((item) => (
            ...
            >
              <Image
                src={`${API_URL}/img/product/${item?.Product.product_picture}`}
                alt={item?.name}
                mr={4}
                width="150px"
                height="150px"
              ...
              <Box>
                ...
                >
                  ...
                  <Button
                    ...
                    variant="solid"
                    onClick={() => {
                      removeWishlist(item.id_product);
                    }}
                  >
                    <AiOutlineDelete />
                  </Button>
